...
from TGRobot import OWNER_ID, BOT_USERNAME, SUPPORT_CHAT
from TGRobot.events import register
from TGRobot import telethn
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./TGRobot/utils/Logo/*")
    ...
    fname = "Cutiepii.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by @ShouyouROBOT")         
    await pesan.delete()
