    ...
    try:
        ...
        if png_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}'s cool (@ChaHaeInBot)" + extra_version,
        ...
        if tgs_sticker:
            success = context.bot.create_new_sticker_set(
                user.id,
                packname,
                f"{name}s cool anime pack (@ChaHaeInBot)" + extra_version,
...
__help__ = """
 ...
 ❍ /kang*:* reply to a sticker to add it to your pack /steal works same as
