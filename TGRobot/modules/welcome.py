...
import TGRobot.modules.sql.welcome_sql as sql
import TGRobot
from TGRobot import (
    DEV_USERS,
    SUNG_ID,
...
from TGRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from TGRobot.modules.helper_funcs.msg_types import get_welcome_type
from TGRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from TGRobot.modules.log_channel import loggable
...
SUNG_IMG = "https://i.imgur.com/ZHz2oqq.png"
KAO_IMG ="https://i.imgur.com/O0bzUO1.jpeg"
KAOR_IMG = "https://i.imgur.com/ZFjxl98.jpeg"
LUCI_IMG = "https://i.imgur.com/l2q1iqk.jpeg"
SATAN_IMG = "https://i.imgur.com/nSGQ3LJ.jpeg"
LEV_IMG = "https://i.imgur.com/8xEfTGn.jpeg"
BEL_IMG = "https://i.imgur.com/4uJxel0.jpeg"
DEV_IMG = "https://i.imgur.com/GbKRxtx.jpeg"
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                  KAO_IMG, caption=f"Oh my God The Cutest Archangel {html.escape(user.first_name)} is here... \nBeware! this person is my Owner.", reply_to_message_id=reply,
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_photo(
                   DEV_IMG, caption=f"Damn! someone from the Public Safety Devil Hunters is here...",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_photo(
                   LUCI_IMG, caption=f"One of the high devils Lucifer is here. \n The bringer of light, representing pride and enlightenment",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_photo(
                   SATAN_IMG, caption=f"Its a Satan get yourself a bible. \n The adversary, representing opposition, the element of fire",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                   LEVI_IMG, caption=f"The Leviatan devil known as the Serpent of the Abyss . \nThe great dragon, representing primal secrecy, the element of water!", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                   BEL_IMG, caption=f"O mai Gawd... Its the masterless devl Belial. \nThe baseness of the earth, independence and self-sufficiency", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh no! my ower left chat... #SedLyf", reply_to_message_id=reply
                )
                return
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "Looks as if the hunt for the devil was over... \nSee ya at P.S.D.H!",
                    reply_to_message_id=reply,
                )
                return
