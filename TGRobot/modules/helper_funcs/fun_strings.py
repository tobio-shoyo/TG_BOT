...
PAT_TEMPLATES = (
    ...
    "@TheSungJinWoo accepts {user2} as a worthy shadow"
    ...
    "(っ´ω`)ﾉ(╥ω╥)",
    "( ´Д｀)ﾉ(´･ω･`) ﾅﾃﾞﾅﾃﾞ",
    "{user2} gets hug from @KazutoSuperbot",
    "{user2} gets a pat from @TheSungJinWoo",
    "@TheSungJinWoo bellyrubs {user2}",
)
...
SLAP_TEMPLATES = (
    ...
    "Round 2!..Ready? .. FIGHT!!",
    "{user1} gbans {user2}",
    "{user2} gets judged by @Sylviorus_Scanner",
    "@TheSungJinWoo attacks {user2} with his Shadow Army",
    "{user2} lost this argument to {user1}",
    "{user1} ignores {user2}",
    "{user1} found grammer error in {user2}'s words",
    "{user1} loses {user2} in a city fair."
)
...
PUNCH_TEMPLATES = (
    ...
    "{user1} {punches} {user2} with Shadow Blade"
)
...
HUG_TEMPLATES = (
    ...
    "{user1} {hug} {user2} with purity",
    "{user1} {hug} {user2} without any reason",
)
