...
import TGRobot.modules.sql.notes_sql as sql
from TGRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from TGRobot.__main__ import DATA_IMPORT
from TGRobot.modules.helper_funcs.chat_status import user_admin
from TGRobot.modules.helper_funcs.alternate import typing_action

# from TGRobot.modules.rules import get_rules
import TGRobot.modules.sql.rules_sql as rulessql

# from TGRobot.modules.sql import warns_sql as warnssql
import TGRobot.modules.sql.blacklist_sql as blacklistsql
from TGRobot.modules.sql import disable_sql as disabledsql

# from TGRobot.modules.sql import cust_filters_sql as filtersql
# import TGRobot.modules.sql.welcome_sql as welcsql
import TGRobot.modules.sql.locks_sql as locksql
from TGRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("TGRobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("TGRobot{}.TGRobot".format(chat_id))  # Cleaning file
