...
from TGRobot.modules.sql import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, Integer, String, UnicodeText

DEFAULT_WELCOME = "Hey {first}, my heartfelt greetings foe you"
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "AinCrad blessings are with you... {first}", #Planet of the apes
    "Elementary, my dear {first}.",
    "I'm back - {first}.",
    "Bond. {first} Bond.",
    "Come with me if you want to live",
    "I know you are Curious lets just get along for now...",
]
