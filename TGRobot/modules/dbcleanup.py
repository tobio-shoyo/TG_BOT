...
import TGRobot.modules.sql.global_bans_sql as gban_sql
import TGRobot.modules.sql.users_sql as user_sql
from TGRobot import DEV_USERS, OWNER_ID, dispatcher
