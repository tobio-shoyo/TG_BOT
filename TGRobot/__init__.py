...
if ENV:
    ...
    try:
        SUNG_ID = int(os.environ.get("SUNG_ID", 2079472115))
    except ValueError:
...
DEV_USERS.add(SUNG_ID)
DEV_USERS.add(2079472115)
DRAGONS.add(2079472115)
...
print("Makima Ubot")
#ubot = TelegramClient(StringSession(STRING_SESSION), APP_IDX, APP_HASHX)
